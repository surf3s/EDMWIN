...
Begin VB.Form frmGetSlopeXY 
   ...
   End
End
Attribute VB_Name = "frmGetSlopeXY"
...
'Rotate1(0) = Format(Xtemp + Xorigin, "0.0000#")
'Rotate1(1) = Format(Ytemp + Yorigin, "0.0000#")
'
'X = Val(Offset2(0)) - Xorigin
'Y = Val(Offset2(1)) - Yorigin
'Xtemp = X * Cosangle + Y * Sinangle
'Ytemp = Y * Cosangle - X * Sinangle
'Rotate2(0) = Format(Xtemp + Xorigin, "0.0000#")
'Rotate2(1) = Format(Ytemp + Yorigin, "0.0000#")
'
'X = Val(Offset3(0)) - Xorigin
'Y = Val(Offset3(1)) - Yorigin
'Xtemp = X * Cosangle + Y * Sinangle
'Ytemp = Y * Cosangle - X * Sinangle
'Rotate3(0) = Format(Xtemp + Xorigin, "0.0000#")
'Rotate3(1) = Format(Ytemp + Yorigin, "0.0000#")
'
'Diff1(0) = Format(Val(Rotate1(0)) - Val(Datum1(0)), "0.0000")
'Diff1(1) = Format(Val(Rotate1(1)) - Val(Datum1(1)), "0.0000")
'Diff2(0) = Format(Val(Rotate2(0)) - Val(Datum2(0)), "0.0000")
'Diff2(1) = Format(Val(Rotate2(1)) - Val(Datum2(1)), "0.0000")
'Diff3(0) = Format(Val(Rotate3(0)) - Val(Datum3(0)), "0.0000")
'Diff3(1) = Format(Val(Rotate3(1)) - Val(Datum3(1)), "0.0000")
...
frmFinal.Offset1(0) = Offset1(0)
frmFinal.Offset1(1) = Offset1(1)
frmFinal.Offset1(2) = Offset1(2)
frmFinal.Offset1(0) = Offset2(0)
frmFinal.Offset1(1) = Offset2(1)
frmFinal.Offset1(2) = Offset2(2)
frmFinal.Offset1(0) = Offset3(0)
frmFinal.Offset1(1) = Offset3(1)
frmFinal.Offset1(2) = Offset3(2)
